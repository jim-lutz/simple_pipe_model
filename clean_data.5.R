...
ggplot(data=DT_test.segments, aes(x=Tpipe.start))+
  ...
  ggtitle("pipe start temperature by test.segment")+
  facet_wrap(~cold.warm, scales = "free_x")

ggsave(filename = "Tpipe.start.png", path=wd_charts)
